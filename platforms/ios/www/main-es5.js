...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    */
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~analytics-analytics-module~contacts-contacts-module~new-product-new-product-module~orders-or~3cde01e0"), __webpack_require__.e("pages-inbox-inbox-module")]).then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~analytics-analytics-module~contacts-contacts-module~new-product-new-product-module~orders-or~3cde01e0"), __webpack_require__.e("pages-reviews-reviews-module")]).then(__webpack_require__.bind(null,
      ...
      loadChildren: function loadChildren() {
        return Promise.all(
        /*! import() | pages-new-product-new-product-module */
      ...
      loadChildren: function loadChildren() {
        ...
        [__webpack_require__.e("default~analytics-analytics-module~contacts-contacts-module~new-product-new-product-module~orders-or~3cde01e0"), __webpack_require__.e("pages-order-detail-order-detail-module")]).then(__webpack_require__.bind(null,
          ...
          this.platform.ready().then(function () {
              ...
              _this.api.get('users/getDefaultSettings').subscribe(function (data) {
                ...
                if (data && data.status === 200 && data.data) {
                  ...
                  if (settings && settings.length > 0) {
                    ...
                    _this.util.user_login = info.store_login;
            ...
            if (_this.platform.is('cordova')) {
                  ...
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.next = 2;
                          return this.oneSignal.startInit(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].onesignal.appId, src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].onesignal.googleProjectNumber);
              ...
              _this.oneSignal.handleNotificationReceived().subscribe(function (data) {
                ...
                _this.nativeAudio.play('audio', function () {
            ...
            if (uid && uid !== null && uid !== 'null') {
              ...
              _this.api.post('stores/getByUid', _param2).subscribe(function (data) {
                console.log('*******************', data);
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pipes_pipe_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./pipes/pipe.module */
    "./src/app/pipes/pipe.module.ts");
    /* harmony import */


    var _pages_category_category_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./pages/category/category.module */
    ...
    var _ionic_native_onesignal_ngx__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! @ionic-native/onesignal/ngx */
    "./node_modules/@ionic-native/onesignal/__ivy_ngcc__/ngx/index.js");
    /* harmony import */
    ...
    var _pages_select_drivers_select_drivers_module__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./pages/select-drivers/select-drivers.module */
    "./src/app/pages/select-drivers/select-drivers.module.ts");
    /* harmony import */


    var _pages_sub_category_sub_category_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./pages/sub-category/sub-category.module */
    ...
    */
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_7__["AppRoutingModule"], _pipes_pipe_module__WEBPACK_IMPORTED_MODULE_10__["PipeModule"], _pages_category_category_module__WEBPACK_IMPORTED_MODULE_11__["CategoryPageModule"], _pages_sub_category_sub_category_module__WEBPACK_IMPORTED_MODULE_19__["SubCategoryPageModule"], _pages_select_drivers_select_drivers_module__WEBPACK_IMPORTED_MODULE_18__["SelectDriversPageModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_12__["ComponentsModule"], _pages_select_country_select_country_module__WEBPACK_IMPORTED_MODULE_21__["SelectCountryPageModule"], _pages_verify_verify_module__WEBPACK_IMPORTED_MODULE_22__["VerifyPageModule"]],
      providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_13__["Camera"], _ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_14__["FileTransferObject"], _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_15__["HTTP"], _ionic_native_onesignal_ngx__WEBPACK_IMPORTED_MODULE_16__["OneSignal"], _ionic_native_printer_ngx__WEBPACK_IMPORTED_MODULE_17__["Printer"], _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_20__["NativeAudio"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_23__["InAppBrowser"], {
  ...
  function srcAppComponentsComponentsModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _closed_closed_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    */
    ...
    var components = [_closed_closed_component__WEBPACK_IMPORTED_MODULE_3__["ClosedComponent"]];
      ...
      _createClass(CategoryPage, [{
        ...
        value: function getCategory() {
          ...
          this.api.get('categories').subscribe(function (data) {
            ...
            if (data && data.status === 200 && data.data && data.data.length) {
              _this4.category = data.data;
              _this4.dummyCate = data.data;
            } else {
              _this4.util.errorToast(_this4.util.getString('No category found'));
            }
          }, function (error) {
        ...
        value: function selected() {
          ...
          var name = this.category.filter(function (x) {
  ...
  function srcAppPagesSelectDriversSelectDriversPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
      ...
      _createClass(SelectDriversPage, [{
        ...
        value: function select() {
          ...
          var driver = this.drivers.filter(function (x) {
            return x.id === _this7.selectedDriver;
          });
          console.log(driver);
    ...
    SelectDriversPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  function srcAppPagesSubCategorySubCategoryPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    var SubCategoryPage = /*#__PURE__*/function () {
      function SubCategoryPage(modalCtrl, api, util, navParam) {
        ...
        this.api.post('subcate/getByCId', param).subscribe(function (data) {
          ...
          if (data && data.status === 200 && data.data && data.data.length) {
            _this8.category = data.data;
            _this8.dummyCate = data.data;
          } else {
            _this8.util.errorToast(_this8.util.getString('No category found'));
          }
        }, function (error) {
    ...
    SubCategoryPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
    ...
    var UtilService = /*#__PURE__*/function () {
      ...
      */
      ...
      _createClass(UtilService, [{
        ...
        key: "getLanguage",
        value: function getLanguage() {// return this.translateService.currentLang;
        }
      }, {
        ...
        value: function showToast(msg, colors, positon) {
          ...
          this.translate(msg).then(function (data) {
        ...
        value: function errorToast(msg) {
          ...
          this.translate(msg).then(function (data) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this15, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee12() {
              var toast;
        ...
        value: function translate(str) {
          ...
          return new Promise(function (resolve, reject) {
            var value = _this16.translations[str];
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/admin/Desktop/Grocery Delivery/ionic5GroceryeeAppFull_V7/App_code/Store_app/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
