...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["analytics-analytics-module"], {
  ...
  function srcAppPagesAnalyticsAnalyticsPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "@charset \"UTF-8\";\n/*\n  Authors : initappz (Rahul Jograna)\n  Website : https://initappz.com/\n  App Name : ionic 5 groceryee app\n  Created : 10-Sep-2020\n  This App Template Source code is licensed as per the\n  terms found in the Website https://initappz.com/license\n  Copyright and Good Faith Purchasers © 2020-present initappz.\n*/\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppPagesAnalyticsAnalyticsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
        ...
        value: function getStats() {
          ...
          if (this.from && this.to) {
            ...
            this.api.post('orders/storeStats', param).subscribe(function (data) {
              ...
              console.log(data); // if (data && data.status === 200 && data.data.length) {
              ...
              if (data && data.status === 200 && data.data.length) {
                ...
                setTimeout(function () {
                  ...
                  console.log(total, _this.storecommission);
                  var totalPrice = percentage(total, parseFloat(_this.storecommission));
                  console.log('commistion=====>>>>>', totalPrice.toFixed(2));
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('invoiceTicket', {
